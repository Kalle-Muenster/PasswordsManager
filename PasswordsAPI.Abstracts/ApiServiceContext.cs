...
{
    public interface IPasswordaApiDbContext<CTX>
    where CTX
        : DbContext
    {
        DbSet<MOD> EntitiesSet<MOD>()
        where MOD 
            : EntityBase<MOD>
            , new();
        void SetEntities<MOD>(DbSet<MOD> dbSet )
        where MOD
            : EntityBase<MOD>
            , new();
    }
        ...
        : PasswordsApiDbContext<CTX>
    {
        ...
        public PasswordsApiDbContext( DbContextOptions<CTX> options )
            : base (options)
        {}
